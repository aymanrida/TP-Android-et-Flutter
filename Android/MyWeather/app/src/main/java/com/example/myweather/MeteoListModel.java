...
public class MeteoListModel extends ArrayAdapter<MeteoItem> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        textViewTempMax.setText(listItems.get(position).tempMax +" °C");
        textViewTempMin.setText(listItems.get(position).tempMin +" °C");
        textViewPression.setText(listItems.get(position).pression +" hPa");
        textViewHumidite.setText(listItems.get(position).humidite +" %");
