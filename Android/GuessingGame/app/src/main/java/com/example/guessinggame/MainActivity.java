...
public class MainActivity extends AppCompatActivity {
    ...
    private int nombreMaxEssais=14;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else if(number<secret){  textViewIndication.setText(getString(R.string.nombre_plus_petit));
        }
        else{
            textViewIndication.setText(R.string.bravo);  scoreCumule+=5;	retry();
        }
